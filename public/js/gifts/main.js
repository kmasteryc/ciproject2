...
$(document).on('click', "#btn_comment", function () {
    ...
    $('#comment_box').html('<div style="text-align: center; margin:10px"><img id="loader-img" alt="" src="'+base_url+'public/img/loading2.gif" /></div>');
...
$(document).on('click', ".btn_comment_rep", function () {
    ...
    $('#reply_to').find(".panel-heading").html(rep_user);
    $('#reply_to').find(".panel-body").html('"'+rep_content+'"');
    $('#reply_to').show();
